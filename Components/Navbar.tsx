...
const Navbar = () => {
  ...
  const NaveItem: FunctionComponent<{
    ...
    return activeItem !== name ? (
      <Link href={route}>
        <a
          className=" dark:text-gray-400 hover: hover:text-blue-500"
  ...
  return (
    <div className="flex flex-col p-4 px-8 lg:flex-row lg:justify-between">
      <div className="flex-row inline pb-2 mb-2 text-2xl text-indigo-500 border-b-2 border-pink-500 dark:text-pink-500 dark:border-indigo-500 lg:flex-row">
        {activeItem}
      </div>
